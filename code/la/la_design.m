...
while count<10
    ...
    SF_cyclical_bending_pin = fatigue([stress_min_bending_pin, stress_max_bending_pin], al1100, false); %??? not sure if C parameter needs to be added
    SF_cyclical_bending_LA = fatigue([stress_min_bending_LA, stress_max_bending_LA], al1100, false);
    ...
    SF_cyclical_axial_pin = fatigue([stress_min_axial_pin, stress_max_axial_pin], al1100, true); %??? not sure if C parameter needs to be added
    SF_cyclical_axial_LA = fatigue([stress_min_axial_LA, stress_max_axial_LA], al1100, true);
